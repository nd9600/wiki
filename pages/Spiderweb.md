...
* Make a post, link it as a `type` to another post afterwards - this is general, it could be used instead of any other way of linking
* Make a post _as_ a `type` to another post
...
[File downloading](https://stackoverflow.com/a/18197341)
